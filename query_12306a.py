...
async def run():
    async with async_playwright() as p:
        ...
        browser = await p.chromium.launch(
            ...
            headless=False  # 设置为 False 可以看到浏览器启动过程
        )
        ...
        try:
            ...
            print(
                f"Setting stations: {stations['from']['text']} -> {stations['to']['text']}...")
            ...
            print(
                "Search submitted successfully. The browser will stay open. Press Ctrl+C in terminal to exit.")
